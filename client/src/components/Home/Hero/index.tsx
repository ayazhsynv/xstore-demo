...
const HomeHero = () => {
  return (
    <div className="page-container">
      <div className="flex not-md:flex-col w-full mt-4 not-md:px-4 gap-4 xl:h-168 lg:h-120 md:h-90 not-md:h-200">
        {/* Left Column */}
        <div className="flex basis-1/3 not-md:basis-2/3 flex-col not-md:px-0 gap-4">
          {/* First Row */}
        ...
        {/* Right Column */}
        <div className="flex basis-2/3 not-md:basis-1/3 not-md:px-0 overflow-hidden relative">
          <Image
